...
<script language="javascript" type="text/javascript">
    ...
    <h1 class="title-regular-4 clearfix">Details for <%=(Request["productNumber"] == null ? "This Month's Special" : "Product #" + Server.HtmlEncode(Request["productNumber"].ToString())) %></h1>
        <div class="notice">
